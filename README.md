...
- **[beta]** [Hermes Live Voice](https://github.com/bielcarpi/hermes-live-voice) by [bielcarpi](https://github.com/bielcarpi) — Self-hosted realtime voice gateway and Dashboard plugin for Hermes, with background run progress and reconnect-safe completion notices. Supports local speech-to-speech on Apple Silicon, Gemini Live, and OpenAI Realtime.
...
- **[beta]** [lintlang](https://github.com/hermes-labs-ai/lintlang) by [Hermes Labs](https://github.com/hermes-labs-ai) — Static analysis for AI agent configs, tool descriptions, and system prompts, returning a PASS / REVIEW / FAIL verdict. Zero-LLM, deterministic checks, built for CI.
- **[beta]** [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) by [Continuum AI](https://github.com/Continuum-AI-Corp) — Records agent runs for byte-for-byte offline replay and lets you fork a run from a checkpoint onto another model. Supports Hermes through its process and socket boundary adapter. Apache-2.0.
- **[beta]** [SandBase CLI](https://github.com/sandbaseai/cli) by [SandBase](https://github.com/sandbaseai) — Open-source CLI and local MCP bridge with a Hermes adapter for routing multimodal generation across 2,000+ models and APIs. Installs a Hermes Skill and MCP entry, with backup and rollback safeguards. Apache-2.0.
...
- **[beta]** [Worklittle Jobs MCP](https://github.com/worklittle/jobs-mcp) by [Worklittle](https://worklittle.com) — Remote MCP connector for searching more than 4 million jobs with visa, distance, and salary filters, and saving roles to a Worklittle account. Uses OAuth.
...
- **Self-improvement without drift** — Pair [hermes-agent-self-evolution](https://github.com/NousResearch/hermes-agent-self-evolution) with scheduled regression checks and [lintlang](https://github.com/hermes-labs-ai/lintlang) for prompt and config linting. The goal isn't "evolve faster" — it's "evolve without quietly getting weird."
